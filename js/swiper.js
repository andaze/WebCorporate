(() => {
  ...
  function Mousewheel(_ref) {
    ...
    function handle(event2) {
      ...
      let target2 = swiper.$el;
      if (swiper.params.mousewheel.eventsTarget !== "container") {
        target2 = dom_default(swiper.params.mousewheel.eventsTarget);
      }
      if (!swiper.mouseEntered && !target2[0].contains(e.target) && !params.releaseOnEdges)
        return true;
      if (e.originalEvent)
        e = e.originalEvent;
      let delta = 0;
    ...
    function events2(method) {
      ...
      target2[method]("mouseenter", handleMouseEnter);
      target2[method]("mouseleave", handleMouseLeave);
      target2[method]("wheel", handle);
    }
    function enable() {
      if (swiper.params.cssMode) {
  ...
  var SlideShow = class {
    ...
    createNewsSwiper() {
      this.newsSwiper = new core_default(".newsSwiper", {
        breakpoints: {
          280: {
            slidesPerView: 1
          },
    ...
    createCasestudySwiper() {
      this.casestudySwiper = new core_default(".casestudySwiper", {
        breakpoints: {
          280: {
            slidesPerView: 1
          },
    ...
    createSustainabilitySwiper() {
      this.sustainabilitySwiper = new core_default(".sustainabilitySwiper", {
        breakpoints: {
          280: {
            slidesPerView: 1
          },
    ...
    createProfessionalSwiper() {
      ...
      let speed = 5e3;
      this.professionalSwiper = new core_default(".professionalSwiper", {
        breakpoints: {
          280: {
            slidesPerView: 1
          },
