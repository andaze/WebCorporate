...
`].filter(Es).join(`
`)),a=lo(a),a=kc(a,e),a=Uc(a,e),r=lo(r),r=kc(r,e),r=Uc(r,e),a=Vc(a),r=Vc(r),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(w=`#version 300 es
