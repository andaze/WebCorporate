...
【会社所在地：東京都／従業員350名／メーカー】  
 以前は大手のパッケージ製品を利用していました。しかし、パッケージ製品のため業務のやり方に合わない仕様が多く、業務非効率につながっています。そのため、業務に最適な販売管理システムをフルスクラッチ開発で刷新することを決めました。  
 これまで数社と面談を行ってきたが、要件定義を推進するための体制やPMの推進力/コミュニケーション能力が求めるレベルではなかったため、要件定義などの上流工程に強みを持つアンダーズ株式会社に決めました。
