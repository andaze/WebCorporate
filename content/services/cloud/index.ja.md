...
【背景】  
現行は大塚商会のSMILEを販売管理システムとして利用しています。しかし、パッケージ製品のため業務のやり方に合わない仕様が多く、業務非効率につながっています。そのため、業務に最適な販売管理システムをフルスクラッチ開発で刷新することを決めました。  
これまで数社と面談を行ってきたが、要件定義を推進するための体制やPMの推進力/コミュニケーション能力が求めるレベルではなかったため、要件定義などの上流工程に強みを持つ会社様を見つけることとなりました。
