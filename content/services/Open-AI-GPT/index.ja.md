...
headerImage:
  ...
  imageDescription: ''
kind: service
description: 革新的なOpenAI/GPTを活用して知的労働を効率化し、システム開発の進化を実現
---
## Azure OpenAI 開発サービス概要

![](/gpt1.png "革新的なOpenAI/GPTを活用して知的労働を効率化し、システム開発の進化を実現")
...
![](/msa.png "OpenAI 開発サービス × Microsoft Azure")
...
![](/gpt4.png "Speech APIとOpenAIを使用したコンタクトセンター分析（例）")
