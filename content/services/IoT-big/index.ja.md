...
![](/iot2.png "「IoT」業務改革や新たなビジネスチャンスにつながる、データ活用をご支援")
...
![](/iot1.png "構造化データ・半構造化データ・非構造化データ")
...
![](/iot3.png "分析用データに加工する「三層データ加工設計」")
...
![](/msa.png "IoT開発サービス × Microsoft Azure")
