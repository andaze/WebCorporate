...
onTopPage: true
kind: service
subtitle: 画像・音声の読み取りによって人の判断を自動化。信頼性の高いデータ解析と予測を提供し、意思決定をサポート
description: 世界最先端の AI モデルを利用して、最先端のアプリケーションを開発するサービスです。ChatGPTインフラストラクチャ上でトレーニングし、推論実行済み&微調整したバージョンの GPT-3.5 を、Azure OpenAI 開発サービスを通じて商用利用できます。様々な業種や用途にご活用ください。
---
# 画像・音声の読み取り、人の判断を自動化
