...
## Salesforce拡張サービス × Microsoft Azure

![](/msa.png)

Salesforce拡張サービスは、Microsoft Azureの機能を活用し、機能とコストの問題を改善します。
...
SalesforceのAzure拡張は、その名の通り、Azureで既存CRMをより使いやすくするためのサービスです。機能は御社のニーズに合わせて、無制限に追加・拡張できます。
